...
import com.orendasoftware.crs.presentation.view_models.home.RelocationViewModel;

public class RelocationFragment extends Fragment {

    private RelocationViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(RelocationViewModel.class);
